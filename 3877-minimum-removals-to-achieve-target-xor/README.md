<h2><a href="https://leetcode.com/problems/minimum-removals-to-achieve-target-xor">4097. Minimum Removals to Achieve Target XOR</a></h2><h3>Medium</h3><hr><p>You are given an integer array <code>nums</code> and an integer <code>target</code>.</p>
